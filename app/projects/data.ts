...
export const projects: Project[] = [
  {
    ...
    shortDescription:
      "Upgrade your Minecraft experience with the Ultramarine Texture Pack!",
    fullDescription:
      "Upgrade your Minecraft experience with the Ultramarine Texture Pack! Enjoy enhanced visuals, lag-free gameplay, and exciting new features with an in-built Shader supported by Render Dragon. Compatible with Minecraft Bedrock 1.20.40+.",
    features: [
    ...
    downloadUrl: "https://mcpedl.com/ultramarine/#downloads",
    credits: [
      {
  ...
  },
  {
    ...
    shortDescription:
      "Best texture pack for Minecraft Bedrock Edition 1.21. Render DragonShader supported.",
    fullDescription:
      "Best texture pack for Minecraft Bedrock Edition 1.21. Render DragonShader supported. Custom swords, ore textures, animations, and more. No lag. Perfect for enhancing gameplay.",
    features: [
      "Dark Mode Support",
      "Improved and compact UI",
    ...
    downloadUrl: "https://mcpedl.com/ultramarine-nightfall/#downloads",
    credits: [
      {
        name: "Quick Craft, Chat Helper, Brewing Guide, Trade Unlocker & Full Grass",
        author: "DrAv0011",
  ...
  },
  {
    ...
    shortDescription:
      "Experience Minecraft in a new light with Neo Texture Pack! Enjoy lag-free gameplay.",
    fullDescription:
      "Experience Minecraft in a new light with Neo Texture Pack! Enjoy lag-free gameplay, enhanced visuals, and exciting new features with Render Dragon-supported in-built Shader. Compatible with Minecraft Bedrock 1.20+. Redefine your gaming experience today!",
    features: [
      "Colorful UI",
      "PVP Mode",
    ...
    downloadUrl:
      "https://www.curseforge.com/minecraft-bedrock/texture-packs/neo-ui-pack-and-shader/download/5847904",
    credits: [
      {
        name: "Bedrock tweaks",
        author: "DrAv0011",
  ...
  },
  {
    ...
    downloadUrl:
      "https://www.curseforge.com/minecraft-bedrock/texture-packs/gui-overhaul/download/6300970",
    credits: [],
    terms: defaultTerms,
    author: defaultAuthor,
  },
  {
    ...
    fullDescription:
      "This pack adds quick loot features for classic UI. So u can loot chests or any other container easily on mobile devices like u can do shift-click in pc. Also, there are two more buttons to drop one item at a time or a stack of items at a time.",
    features: ["Drop one item at a time", "Drop a stack of items at a time"],
    category: "texture-pack",
    version: "1.20+",
    size: "2MB",
    stars: 4.2,
    ...
    downloadUrl: "https://mcpedl.com/quick-loot/#downloads",
    credits: [],
    terms: defaultTerms,
    author: defaultAuthor,
  },
  ...
  },
  {
    ...
    shortDescription:
      "This mod will allow you to unlock crafting recipes for uncraftable items and blocks in the game.",
    fullDescription:
      "This mod will allow you to unlock crafting recipes for uncraftable items and blocks in the game. There are 80+ new crafting recipes for items like Totem, Enchanted Golden Apple, saddle, elytra, dragon eggs, etc",
    features: [
    ...
    downloadUrl:
      "https://www.curseforge.com/minecraft-bedrock/addons/craft-everything/download/5366745",
    credits: [],
    terms: defaultTerms,
    author: defaultAuthor,
  },
  {
    ...
    title: "Akinator",
    shortDescription:
      "In this map, The Akinator can guess the Minecraft mob , you are thinking of",
    fullDescription:
      "In this map, The Akinator can guess the Minecraft mob , you are thinking of. Just answer some simple yes-no questions and Boom..... That is the mob You thinking of. Hope you will enjoy",
    features: [
    ...
    downloadUrl:
      "https://www.curseforge.com/minecraft-bedrock/maps/akinator/download/5582646",
    credits: [],
    terms: defaultTerms,
    author: defaultAuthor,
  },
  {
    ...
    shortDescription:
      "A map designed for Minecraft Bedrock Edition, which helps players complete achievements, was added after version 1.21.",
    fullDescription:
    ...
    size: "400kb",
    stars: 4.5,
    previewImages: ["/images/achievements/achievements-world.png"],
  ...
  },
  {
    ...
    shortDescription:
      "Experience Minecraft like never before with the Talking Villagers Pack!",
    fullDescription:
      "Experience Minecraft like never before with the Talking Villagers Pack! This pack brings your villagers to life with funny and random dialogues, making your Minecraft world more entertaining than ever—perfect for those playing solo. It is super necessary if you don't have friends like me 🥲",
    features: [
    ...
    size: "410kb",
    stars: 4.0,
    previewImages: ["/images/villager/villager.png"],
  ...
  },
  {
    ...
    shortDescription:
      'Are you ready to challenge yourself for this parkour map. Welcome to the " Mini Parkour Map"',
    fullDescription:
  ...
  },
  {
    ...
    shortDescription:
      'Known for its difficulty, the "Neo Jump" requires precise timing and skill to leap around obstacles.',
    fullDescription:
    ...
    size: "157kb",
    stars: 5.0,
    previewImages: ["/images/miniparkour/neo.png"],
